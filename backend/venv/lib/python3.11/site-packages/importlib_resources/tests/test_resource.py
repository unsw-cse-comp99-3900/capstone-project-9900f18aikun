...
class ResourceLoaderTests(unittest.TestCase):
    ...
    def test_is_file(self):
        package = util.create_package(
            file=data01, path=data01.__file__, contents=[
                'A', 'B', 'C', 'D/E', 'D/F'])
...
class ResourceFromZipsTest01(util.ZipSetupBase, unittest.TestCase):
    ...
    def test_is_submodule_resource(self):
        ...
        self.assertTrue(resources.files(
            submodule).joinpath('binary.file').is_file())

    def test_read_submodule_resource_by_name(self):
        self.assertTrue(resources.files(
            'data01.subdirectory').joinpath('binary.file').is_file())
...
class DeletingZipsTest(util.ZipSetupBase, unittest.TestCase):
    ...
    def test_read_text_does_not_keep_open(self):
        resources.files('data01').joinpath(
            'utf-8.file').read_text(encoding='utf-8')
...
class ResourceFromNamespaceTests:
    ...
    def test_read_submodule_resource_by_name(self):
        self.assertTrue(resources.files(
            'namespacedata01').joinpath('binary.file').is_file())
    ...
    def test_submodule_sub_contents(self):
        contents = names(
            resources.files(
                import_module('namespacedata01.subdirectory')))
        try:
            contents.remove('__pycache__')
        except KeyError:
            pass
