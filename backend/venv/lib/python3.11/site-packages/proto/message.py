...
class MessageMeta(type):
    ...
    def __new__(mcls, name, bases, attrs):
        ...
        for key, field in attrs.items():
            ...
            map_fields[msg_name] = MessageMeta(
                msg_name, (Message,), entry_attrs)
    ...
    def _normalize_print_fields_without_presence(
        ...
        # Default to True if neither `always_print_fields_with_no_presence` or
        # `including_default_value_fields` is set
        return (
            (
