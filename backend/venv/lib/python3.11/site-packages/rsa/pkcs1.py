...
def decrypt(crypto: bytes, priv_key: key.PrivateKey) -> bytes:
    ...
    if len(crypto) > blocksize:
        # This is operating on public information, so doesn't need to be
        # constant-time.
...
def yield_fixedblocks(infile: typing.BinaryIO,
                      blocksize: int) -> typing.Iterator[bytes]:
...
def compute_hash(
        message: typing.Union[bytes, typing.BinaryIO], method_name: str) -> bytes:
