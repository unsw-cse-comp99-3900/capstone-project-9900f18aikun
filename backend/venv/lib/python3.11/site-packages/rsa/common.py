...
class NotRelativePrimeError(ValueError):
    def __init__(self, a: int, b: int, d: int, msg: str = "") -> None:
        super().__init__(
            msg or "%d and %d are not relatively prime, divider=%i" %
            (a, b, d))
        self.a = a
        self.b = b
        self.d = d
...
def bit_size(num: int) -> int:
    ...
    try:
        ...
        raise TypeError(
            "bit_size(num) only supports integers, not %r" %
            type(num)) from ex
...
def crt(a_values: typing.Iterable[int],
        modulo_values: typing.Iterable[int]) -> int:
