...
class ModelServiceRestTransport(ModelServiceTransport):
    ...
    class _GetModel(ModelServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_get_model(
                request, metadata)
    ...
    class _GetTunedModel(ModelServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_get_tuned_model(
                request, metadata)
    ...
    class _ListModels(ModelServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_list_models(
                request, metadata)
    ...
    def create_tuned_model(self,
                           ) -> Callable[[model_service.CreateTunedModelRequest],
                                         operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._CreateTunedModel(
            self._session,
            self._host,
    ...
    @property
    def get_model(
            self) -> Callable[[model_service.GetModelRequest], model.Model]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get_tuned_model(self,
                        ) -> Callable[[model_service.GetTunedModelRequest],
                                      tuned_model.TunedModel]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._GetTunedModel(
            self._session,
            self._host,
            self._interceptor)  # type: ignore
    ...
    def list_tuned_models(self,
                          ) -> Callable[[model_service.ListTunedModelsRequest],
                                        model_service.ListTunedModelsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._ListTunedModels(
            self._session,
            self._host,
            self._interceptor)  # type: ignore
    ...
    def update_tuned_model(self,
                           ) -> Callable[[model_service.UpdateTunedModelRequest],
                                         gag_tuned_model.TunedModel]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._UpdateTunedModel(
            self._session,
            self._host,
            self._interceptor)  # type: ignore
