...
class TextServiceRestTransport(TextServiceTransport):
    ...
    class _EmbedText(TextServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_embed_text(
                request, metadata)
    ...
    class _GenerateText(TextServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_generate_text(
                request, metadata)
    ...
    def batch_embed_text(self,
                         ) -> Callable[[text_service.BatchEmbedTextRequest],
                                       text_service.BatchEmbedTextResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._BatchEmbedText(
            self._session,
            self._host,
    ...
    def count_text_tokens(self,
                          ) -> Callable[[text_service.CountTextTokensRequest],
                                        text_service.CountTextTokensResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._CountTextTokens(
            self._session,
            self._host,
            self._interceptor)  # type: ignore
    ...
    @property
    def embed_text(self,
                   ) -> Callable[[text_service.EmbedTextRequest],
                                 text_service.EmbedTextResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
