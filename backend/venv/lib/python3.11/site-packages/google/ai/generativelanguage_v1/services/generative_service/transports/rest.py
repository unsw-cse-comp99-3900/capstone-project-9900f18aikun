...
class GenerativeServiceRestTransport(GenerativeServiceTransport):
    ...
    class _BatchEmbedContents(GenerativeServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = generative_service.BatchEmbedContentsRequest.pb(
                request)
    ...
    class _CountTokens(GenerativeServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_count_tokens(
                request, metadata)
    ...
    class _EmbedContent(GenerativeServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_embed_content(
                request, metadata)
    ...
    def batch_embed_contents(
        ...
        return self._BatchEmbedContents(
            self._session, self._host, self._interceptor)  # type: ignore

    @property
    def count_tokens(self,
                     ) -> Callable[[generative_service.CountTokensRequest],
                                   generative_service.CountTokensResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._CountTokens(
            self._session,
            self._host,
    ...
    def stream_generate_content(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._StreamGenerateContent(
            self._session, self._host, self._interceptor)  # type: ignore
    ...
    class _GetOperation(GenerativeServiceRestStub):
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_get_operation(
                request, metadata)
            request_kwargs = json_format.MessageToDict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
    ...
    class _ListOperations(GenerativeServiceRestStub):
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_list_operations(
                request, metadata)
            request_kwargs = json_format.MessageToDict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
