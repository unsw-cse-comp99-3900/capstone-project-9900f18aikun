...
class PermissionServiceRestTransport(PermissionServiceTransport):
    ...
    class _GetPermission(PermissionServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_get_permission(
                request, metadata)
    ...
    class _TransferOwnership(PermissionServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = permission_service.TransferOwnershipRequest.pb(
                request)
            transcoded_request = path_template.transcode(
                http_options, pb_request)
    ...
    def get_permission(self,
                       ) -> Callable[[permission_service.GetPermissionRequest],
                                     permission.Permission]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
