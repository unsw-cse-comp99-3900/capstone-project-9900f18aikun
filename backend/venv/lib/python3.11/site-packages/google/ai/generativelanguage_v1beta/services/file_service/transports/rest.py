...
class FileServiceRestTransport(FileServiceTransport):
    ...
    class _CreateFile(FileServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_create_file(
                request, metadata)
    ...
    class _DeleteFile(FileServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_delete_file(
                request, metadata)
    ...
    class _GetFile(FileServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_get_file(
                request, metadata)
    ...
    class _ListFiles(FileServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_list_files(
                request, metadata)
    ...
    def create_file(self,
                    ) -> Callable[[file_service.CreateFileRequest],
                                  file_service.CreateFileResponse]:
    ...
    @property
    def list_files(self,
                   ) -> Callable[[file_service.ListFilesRequest],
                                 file_service.ListFilesResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
