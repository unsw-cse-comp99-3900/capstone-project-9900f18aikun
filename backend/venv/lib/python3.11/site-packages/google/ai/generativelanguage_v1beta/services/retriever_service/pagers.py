...
class ListCorporaAsyncPager:
    ...
    @property
    async def pages(
            self) -> AsyncIterator[retriever_service.ListCorporaResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListDocumentsAsyncPager:
    ...
    @property
    async def pages(
            self) -> AsyncIterator[retriever_service.ListDocumentsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
...
class ListChunksAsyncPager:
    ...
    @property
    async def pages(
            self) -> AsyncIterator[retriever_service.ListChunksResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
