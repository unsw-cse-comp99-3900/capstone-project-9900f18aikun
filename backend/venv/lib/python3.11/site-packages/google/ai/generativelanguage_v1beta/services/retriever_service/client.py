...
class RetrieverServiceClient(metaclass=RetrieverServiceClientMeta):
    ...
    def parse_document_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^corpora/(?P<corpus>.+?)/documents/(?P<document>.+?)$",
            path)
        return m.groupdict() if m else {}
    ...
    def _read_environment_variables():
        ...
        use_mtls_endpoint = os.getenv(
            "GOOGLE_API_USE_MTLS_ENDPOINT", "auto").lower()
    ...
    def _get_universe_domain(
            ...
            universe_domain_env: Optional[str]) -> str:
    ...
    def _compare_universes(
        ...
        credentials_universe = getattr(
            credentials, "universe_domain", default_universe)
    ...
    def __init__(self,
                 *,
                 ...
                 transport: Optional[Union[str,
                                           ...
                                           Callable[...,
                                                    RetrieverServiceTransport]]] = None,
                 client_options: Optional[Union[client_options_lib.ClientOptions,
                                                dict]] = None,
