...
class FileServiceTransport(abc.ABC):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if (always_use_jwt_access and isinstance(credentials,
                                                 service_account.Credentials) and hasattr(service_account.Credentials,
    ...
    def create_file(self,
                                  ...
                                  Union[file_service.CreateFileResponse,
    ...
    def list_files(self,
                                 ...
                                 Union[file_service.ListFilesResponse,
