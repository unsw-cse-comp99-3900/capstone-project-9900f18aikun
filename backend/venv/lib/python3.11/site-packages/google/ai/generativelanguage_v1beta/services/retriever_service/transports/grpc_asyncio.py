...
class RetrieverServiceGrpcAsyncIOTransport(RetrieverServiceTransport):
    ...
    def create_corpus(self,
                      ) -> Callable[[retriever_service.CreateCorpusRequest],
    ...
    @property
    def get_corpus(self,
                   ) -> Callable[[retriever_service.GetCorpusRequest],
                                 Awaitable[retriever.Corpus]]:
    ...
    def update_corpus(self,
                      ) -> Callable[[retriever_service.UpdateCorpusRequest],
                                    Awaitable[retriever.Corpus]]:
    ...
    def delete_corpus(self,
                      ) -> Callable[[retriever_service.DeleteCorpusRequest],
    ...
    def create_document(self,
                        ) -> Callable[[retriever_service.CreateDocumentRequest],
    ...
    def update_document(self,
                        ) -> Callable[[retriever_service.UpdateDocumentRequest],
                                      Awaitable[retriever.Document]]:
    ...
    def create_chunk(self,
                     ) -> Callable[[retriever_service.CreateChunkRequest],
    ...
    @property
    def get_chunk(self,
                  ) -> Callable[[retriever_service.GetChunkRequest],
                                Awaitable[retriever.Chunk]]:
    ...
    def update_chunk(self,
                     ) -> Callable[[retriever_service.UpdateChunkRequest],
                                   Awaitable[retriever.Chunk]]:
    ...
    def delete_chunk(self,
                     ) -> Callable[[retriever_service.DeleteChunkRequest],
                                   Awaitable[empty_pb2.Empty]]:
    ...
    def batch_delete_chunks(self,
                            ) -> Callable[[retriever_service.BatchDeleteChunksRequest],
                                          Awaitable[empty_pb2.Empty]]:
