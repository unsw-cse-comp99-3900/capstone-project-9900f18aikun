...
class _Parser(object):
    ...
    def _MergeField(self, tokenizer, message):
        ...
        if field:
            ...
            self._SkipFieldContents(
                tokenizer, name, message_descriptor.full_name)
    ...
    def _SkipFieldContents(
        ...
        if tokenizer.TryConsume(':') and not tokenizer.LookingAt(
            ...
            self._DetectSilentMarker(
                tokenizer, immediate_message_type, field_name)
...
class Tokenizer(object):
    ...
    def _SkipWhitespace(self):
        while True:
            ...
            if not match:
                break
            self.contains_silent_marker_before_current_token = match.group(
                0) == (' ' + _DEBUG_STRING_SILENT_MARKER)
