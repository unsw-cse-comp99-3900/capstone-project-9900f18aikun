...
class Credentials(external_account.Credentials):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Dummy value. This variable is only used via injection, not exposed to
        # ctor
    ...
    def retrieve_subject_token(self, request):
        ...
        if self._credential_source_executable_output_file is not None:
            try:
                ...
                try:
                    # If the cached response is expired, _parse_subject_token
                    # will raise an error which will be ignored and we will
                    # call the executable again.
                    subject_token = self._parse_subject_token(response)
                    # Always treat missing expiration_time as expired and
                    # proceed to executable run.
