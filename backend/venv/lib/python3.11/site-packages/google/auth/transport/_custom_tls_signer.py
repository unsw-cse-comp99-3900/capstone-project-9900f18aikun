...
def load_signer_lib(signer_lib_path):
    ...
    # Set up types for:
    # func GetCertPemForPython(configFilePath *C.char, certHolder *byte,
    # certHolderLen int)
...
class CustomTlsSigner(object):
    ...
    def set_up_custom_key(self):
        ...
        # be garbage collected, otherwise it will crash when used by signer
        # lib.
        self._cert = get_cert(
            self._signer_lib,
            self._enterprise_cert_file_path)
