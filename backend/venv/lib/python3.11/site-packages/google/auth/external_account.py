...
class Credentials(
    ...
    def __init__(
        ...
        if not self.is_workforce_pool and self._workforce_pool_user_project:
            # Workload identity pools do not support workforce pool user
            # projects.
    ...
    def _constructor_args(self):
        args = {
            ...
            "service_account_impersonation_options": copy.deepcopy(
                self._service_account_impersonation_options) or None,
    ...
    def refresh(self, request):
        ...
        if self._impersonated_credentials:
            ...
            # is used. The client ID is sufficient for determining the user
            # project.
