...
# The AWS authorization header name for the security session token if
# available.
...
# IMDSV2 session token lifetime. This is set to a low value because the
# session token is used immediately.
...
class RequestSigner(object):
    ...
    def get_request_options(
        ...
        # Append additional optional headers, eg. X-Amz-Target, Content-Type,
        # etc.
...
class Credentials(external_account.Credentials):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if aws_security_credentials_supplier:
            ...
            # The regional cred verification URL would normally be provided
            # through the credential source. So set it to the default one here.
            ...
            # Get the environment ID, i.e. "aws1". Currently, only one version
            # supported (1).
    ...
    def _create_default_metrics_options(self):
        metrics_options = super(Credentials,
                                self)._create_default_metrics_options()
