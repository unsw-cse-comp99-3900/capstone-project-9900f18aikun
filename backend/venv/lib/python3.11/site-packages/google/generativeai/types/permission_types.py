...
class Permission:
    ...
    # TODO (magashe): Add a method to validate update value. As of now only
    # `role` is supported as a mask path
...
class Permissions:
    ...
    def create(
        ...
        permission_response = type(
            permission_response).to_dict(permission_response)
