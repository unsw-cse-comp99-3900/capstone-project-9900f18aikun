...
class GenerativeModel:
    ...
    def __init__(
        ...
        self._safety_settings = safety_types.to_easy_safety_dict(
            safety_settings)
        self._generation_config = generation_types.to_generation_config_dict(
            generation_config)
        ...
        if system_instruction is None:
            ...
            self._system_instruction = content_types.to_content(
                system_instruction)
    ...
    def _prepare_request(
        ...
        *,
        ...
        if hasattr(self, "_cached_content") and any(
                [self._system_instruction, tools, tool_config]):
            raise ValueError(
        ...
        * `str`, `Image`, or `protos.Blob`
        ...
        try:
            if stream:
                ...
                return generation_types.GenerateContentResponse.from_iterator(
                    iterator)
            else:
                ...
                return generation_types.GenerateContentResponse.from_response(
                    response)
...
class ChatSession:
    ...
    def __init__(
        ...
        self._history: list[protos.Content] = content_types.to_contents(
            history)
    ...
    def _check_response(self, *, response, stream):
        ...
        if not stream:
            if response.candidates[0].finish_reason not in (
                ...
                raise generation_types.StopCandidateException(
    ...
    def _get_function_calls(self, response) -> list[protos.FunctionCall]:
        ...
        function_calls = [
            part.function_call for part in parts if part and "function_call" in part]
        return function_calls

    def _handle_afc(self,
                    *,
                    response,
                    history,
                    generation_config,
                    ...
                    tools_lib,
                    request_options,
                    ) -> tuple[list[protos.Content],
                               protos.Content,
                               generation_types.BaseGenerateContentResponse]:
    ...
    async def _handle_afc_async(self,
                                *,
                                response,
                                history,
                                generation_config,
