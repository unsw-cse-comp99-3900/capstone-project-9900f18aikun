...
class _Channel(grpc.Channel):
    ...
    def unary_unary(
        ...
        def thunk(m): return self._channel.unary_unary(
            m,
            request_serializer,
    ...
    def unary_stream(
        ...
        # pytype: disable=wrong-arg-count
        def thunk(m): return self._channel.unary_stream(
            m,
            request_serializer,
            response_deserializer,
            _registered_method,
    ...
    def stream_unary(
        ...
        # pytype: disable=wrong-arg-count
        def thunk(m): return self._channel.stream_unary(
            m,
            request_serializer,
            response_deserializer,
            _registered_method,
    ...
    def stream_stream(
        ...
        # pytype: disable=wrong-arg-count
        def thunk(m): return self._channel.stream_stream(
            m,
            request_serializer,
            response_deserializer,
            _registered_method,
