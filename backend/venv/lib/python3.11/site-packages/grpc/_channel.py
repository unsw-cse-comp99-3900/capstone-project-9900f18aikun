    ...
    def handle_event(event):
        ...
        for callback in callbacks:
            try:
                ...
                logging.error(
                    "Exception in callback %s: %s", repr(
...
class _InactiveRpcError(grpc.RpcError, grpc.Call, grpc.Future):
    ...
    def __init__(self, state: _RPCState):
        with state.condition:
            ...
            self._state.debug_error_string = copy.copy(
...
class _SingleThreadedRendezvous(
    ...
    def exception(
            self,
            timeout: Optional[float] = None) -> Optional[Exception]:
...
class _UnaryUnaryMultiCallable(grpc.UnaryUnaryMultiCallable):
    ...
    def __call__(
        ...
        (state, call, ) = self._blocking(request, timeout,
