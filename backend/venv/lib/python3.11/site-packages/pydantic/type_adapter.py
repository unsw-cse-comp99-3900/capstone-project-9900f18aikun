...
def _type_has_config(type_: Any) -> bool:
    ...
    try:
        return issubclass(type_, BaseModel) or is_dataclass(
            type_) or is_typeddict(type_)
    except TypeError:
        # type is not a class
        return False
...
class TypeAdapter(Generic[T]):
    ...
    **Note:** `TypeAdapter` instances are not types, and cannot be used as type annotations for fields.
        ...
        *,
        ...
        try:
            ...
            validator = create_schema_validator(
                ...
                'TypeAdapter',
                core_config,
                config_wrapper.plugin_settings)  # type: ignore
    ...
    def validate_json(self, data: str | bytes, /, *, strict: bool |
                      None = None, context: dict[str, Any] | None = None) -> T:
    ...
    def validate_strings(self, obj: Any, /, *, strict: bool |
                         None = None, context: dict[str, Any] | None = None) -> T:
    ...
    def json_schemas(
        ...
        *,
        ...
        inputs_ = [(key, mode, adapter.core_schema)
