...
class Color(_repr.Representation):
    ...
    def __get_pydantic_json_schema__(
            ...
            handler: _GetJsonSchemaHandler) -> JsonSchemaValue:
        field_schema = {}
    ...
    def __eq__(self, other: Any) -> bool:
        return isinstance(
            other, Color) and self.as_rgb_tuple() == other.as_rgb_tuple()
...
def ints_to_rgba(r: Union[int, str], g: Union[int, str],
                 b: Union[int, str], alpha: Optional[float] = None) -> RGBA:
...
def parse_hsl(h: str, h_units: str, sat: str, light: str,
