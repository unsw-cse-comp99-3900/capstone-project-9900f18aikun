...
def update_json_schema(schema: JsonSchemaValue,
                       updates: dict[str, Any]) -> JsonSchemaValue:
        ...
        for _iter in range(
            ...
            for original_defs_ref in definitions:
                ...
                remapped_defs_ref = next(
                    x for x in alternatives if len(
...
class GenerateJsonSchema:
        ...
        for key in core_schema_types:
            ...
            try:
                ...
                raise TypeError(
                    ...
                    f'(expected: {type(self).__name__}.{method_name})') from e
        return mapping
    ...
    def generate_definitions(
        ...
        self._used = True
        return json_schemas_map, _sort_json_schema(
            json_schema['$defs'])  # type: ignore

    def generate(
            self,
            schema: CoreSchema,
            mode: JsonSchemaMode = 'validation') -> JsonSchemaValue:
        ...
        # Remove the top-level $ref if present; note that the _generate method
        # already ensures there are no sibling keys
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:  # noqa: C901
        ...
        if 'ref' in schema:
            ...
            if core_mode_ref in self.core_to_defs_refs and self.core_to_defs_refs[
                    core_mode_ref] in self.definitions:
                return {'$ref': self.core_to_json_refs[core_mode_ref]}

        # Generate the JSON schema, accounting for the json_schema_override and
        # core_schema_override
        metadata_handler = _core_metadata.CoreMetadataHandler(schema)

        def populate_defs(core_schema: CoreSchema,
                          json_schema: JsonSchemaValue) -> JsonSchemaValue:
        ...
        def convert_to_all_of(json_schema: JsonSchemaValue) -> JsonSchemaValue:
            if '$ref' in json_schema and len(json_schema.keys()) > 1:
                ...
                # but it's an easy mistake to make and not hard to correct
                # automatically here
        ...
        def handler_func(
                schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
            ...
            if json_schema is None:
                if _core_utils.is_core_schema(
                        schema_or_field) or _core_utils.is_core_schema_field(schema_or_field):
    ...
    def decimal_schema(
            self,
            schema: core_schema.DecimalSchema) -> JsonSchemaValue:
    ...
    def datetime_schema(
            self,
            schema: core_schema.DatetimeSchema) -> JsonSchemaValue:
    ...
    def timedelta_schema(
            self,
            schema: core_schema.TimedeltaSchema) -> JsonSchemaValue:
    ...
    def literal_schema(
            self,
            schema: core_schema.LiteralSchema) -> JsonSchemaValue:
    ...
    def is_instance_schema(
            self,
            schema: core_schema.IsInstanceSchema) -> JsonSchemaValue:
    ...
    def is_subclass_schema(
            self,
            schema: core_schema.IsSubclassSchema) -> JsonSchemaValue:
    ...
    def callable_schema(
            self,
            schema: core_schema.CallableSchema) -> JsonSchemaValue:
    ...
    def tuple_positional_schema(
            self, schema: core_schema.TupleSchema) -> JsonSchemaValue:
    ...
    def tuple_variable_schema(
            self,
            schema: core_schema.TupleSchema) -> JsonSchemaValue:
        """Replaced by `tuple_schema`."""
        warnings.warn(
    ...
    def tuple_schema(self, schema: core_schema.TupleSchema) -> JsonSchemaValue:
        ...
        if 'variadic_item_index' in schema:
            ...
            if variadic_item_index > 0:
                ...
                json_schema['prefixItems'] = [self.generate_inner(
                    item) for item in schema['items_schema'][:variadic_item_index]]
    ...
    def frozenset_schema(
            self,
            schema: core_schema.FrozenSetSchema) -> JsonSchemaValue:
    ...
    def _common_set_schema(self, schema: core_schema.SetSchema |
                           core_schema.FrozenSetSchema) -> JsonSchemaValue:
        items_schema = {} if 'items_schema' not in schema else self.generate_inner(
            schema['items_schema'])
        json_schema = {
            'type': 'array',
    ...
    def generator_schema(
            self,
            schema: core_schema.GeneratorSchema) -> JsonSchemaValue:
    ...
    def _function_schema(
        ...
        if _core_utils.is_function_with_inner_schema(schema):
            ...
            # isn't, I think it would be hard to automatically infer what the
            # desired schema should be.
    ...
    def function_before_schema(
            self,
            schema: core_schema.BeforeValidatorFunctionSchema) -> JsonSchemaValue:
    ...
    def function_after_schema(
            self,
            schema: core_schema.AfterValidatorFunctionSchema) -> JsonSchemaValue:
    ...
    def function_plain_schema(
            self,
            schema: core_schema.PlainValidatorFunctionSchema) -> JsonSchemaValue:
    ...
    def function_wrap_schema(
            self,
            schema: core_schema.WrapValidatorFunctionSchema) -> JsonSchemaValue:
    ...
    def default_schema(
            self,
            schema: core_schema.WithDefaultSchema) -> JsonSchemaValue:
        ...
        if '$ref' in json_schema:
            # Since reference schemas do not support child keys, we wrap the
            # reference schema in a single-case allOf:
    ...
    def nullable_schema(
            self,
            schema: core_schema.NullableSchema) -> JsonSchemaValue:
    ...
    def tagged_union_schema(
            self,
            schema: core_schema.TaggedUnionSchema) -> JsonSchemaValue:
    ...
    def _extract_discriminator(self,
        ...
        if isinstance(schema['discriminator'], list):
            ...
            if len(
                    schema['discriminator']) == 1 and isinstance(
            ...
            for alias_path in schema['discriminator']:
                ...
                for choice in one_of_choices:
                    ...
                    if not isinstance(
                            properties, dict) or alias not in properties:
    ...
    def lax_or_strict_schema(
            self,
            schema: core_schema.LaxOrStrictSchema) -> JsonSchemaValue:
    ...
    def json_or_python_schema(
            self,
            schema: core_schema.JsonOrPythonSchema) -> JsonSchemaValue:
    ...
    def typed_dict_schema(
            self,
            schema: core_schema.TypedDictSchema) -> JsonSchemaValue:
    ...
    def _name_required_computed_fields(
        ...
        return [(field['property_name'], True, field)
    ...
    def _get_alias_name(self, field: CoreSchemaField, name: str) -> str:
        ...
        if isinstance(alias, str):
            ...
            for path in alias:
                if isinstance(
                        path,
                        list) and len(path) == 1 and isinstance(
                        path[0],
                        str):
    ...
    def typed_dict_field_schema(
            self,
            schema: core_schema.TypedDictField) -> JsonSchemaValue:
    ...
    def dataclass_field_schema(
            self,
            schema: core_schema.DataclassField) -> JsonSchemaValue:
    ...
    def model_field_schema(
            self,
            schema: core_schema.ModelField) -> JsonSchemaValue:
    ...
    def computed_field_schema(
            self,
            schema: core_schema.ComputedField) -> JsonSchemaValue:
    ...
    def model_schema(self, schema: core_schema.ModelSchema) -> JsonSchemaValue:
        ...
        json_schema = self._update_class_schema(
            json_schema, title, config.get(
                'extra', None), cls, json_schema_extra)
    ...
    def resolve_schema_to_update(
            self, json_schema: JsonSchemaValue) -> JsonSchemaValue:
    ...
    def model_fields_schema(
            self,
            schema: core_schema.ModelFieldsSchema) -> JsonSchemaValue:
    ...
    def dataclass_args_schema(
            self,
            schema: core_schema.DataclassArgsSchema) -> JsonSchemaValue:
    ...
    def dataclass_schema(
            self,
            schema: core_schema.DataclassSchema) -> JsonSchemaValue:
    ...
    def arguments_schema(
            self,
            schema: core_schema.ArgumentsSchema) -> JsonSchemaValue:
        ...
        kw_or_p_arguments = [
            a for a in arguments if a.get('mode') in {
                'positional_or_keyword', None}]
        p_only_arguments = [
    ...
    def kw_arguments_schema(self,
                            arguments: list[core_schema.ArgumentsParameter],
                            var_kwargs_schema: CoreSchema | None) -> JsonSchemaValue:
    ...
    def p_arguments_schema(self,
                           arguments: list[core_schema.ArgumentsParameter],
                           var_args_schema: CoreSchema | None) -> JsonSchemaValue:
    ...
    def get_argument_name(
            self,
            argument: core_schema.ArgumentsParameter) -> str:
    ...
    def custom_error_schema(
            self,
            schema: core_schema.CustomErrorSchema) -> JsonSchemaValue:
    ...
    def multi_host_url_schema(
            self,
            schema: core_schema.MultiHostUrlSchema) -> JsonSchemaValue:
    ...
    def definitions_schema(
            self,
            schema: core_schema.DefinitionsSchema) -> JsonSchemaValue:
    ...
    def definition_ref_schema(
            self,
            schema: core_schema.DefinitionReferenceSchema) -> JsonSchemaValue:
    ...
    def ser_schema(self, schema: core_schema.SerSchema | core_schema.IncExSeqSerSchema |
                   core_schema.IncExDictSerSchema) -> JsonSchemaValue | None:
    ...
    def field_title_should_be_set(self, schema: CoreSchemaOrField) -> bool:
        ...
        if _core_utils.is_core_schema_field(schema):
            ...
            if schema.get(
                    'ref'):  # things with refs, such as models and enums, should not have titles set
                return False
            if schema['type'] in {'default', 'nullable', 'definitions'}:
                return self.field_title_should_be_set(
                    schema['schema'])  # type: ignore[typeddict-item]
            if _core_utils.is_function_with_inner_schema(schema):
    ...
    def get_cache_defs_ref_schema(
            self, core_ref: CoreRef) -> tuple[DefsRef, JsonSchemaValue]:
        ...
        if '$ref' in json_schema:
            ...
            if referenced_json_schema is None:
                ...
                if len(json_schema) > 1:
                    # Make it an allOf to at least resolve the sibling keys
                    # issue
                    json_schema = json_schema.copy()
            ...
            if len(json_schema) > 1:
                # There is a remaining "override" key, so we need to move $ref
    ...
    def get_schema_from_definitions(
            self, json_ref: JsonRef) -> JsonSchemaValue | None:
    ...
    def encode_default(self, dft: Any) -> Any:
        ...
        try:
            default = (
                dft if _type_has_config(
                    type(dft)) else TypeAdapter(
                    type(dft),
                    config=config.config_dict).dump_python(
                    dft,
                    mode='json'))
    ...
    def update_with_validations(self,
                                json_schema: JsonSchemaValue,
    ...
    def get_flattened_anyof(
            self,
            schemas: list[JsonSchemaValue]) -> JsonSchemaValue:
        members = []
    ...
    def get_json_ref_counts(
            self, json_schema: JsonSchemaValue) -> dict[JsonRef, int]:
    ...
    def handle_invalid_for_json_schema(
            ...
            error_info: str) -> JsonSchemaValue:
        raise PydanticInvalidForJsonSchema(
    ...
    def _garbage_collect_definitions(self, schema: JsonSchemaValue) -> None:
        ...
        self.definitions = {
            k: v for k,
            v in self.definitions.items() if k in visited_defs_refs}
...
_HashableJsonValue: TypeAlias = Union[int, float, str, bool, None,
                                      Tuple['_HashableJsonValue', ...], Tuple[Tuple[str, '_HashableJsonValue'], ...]]
...
def _make_json_hashable(value: JsonValue) -> _HashableJsonValue:
    if isinstance(value, dict):
        return tuple(sorted((k, _make_json_hashable(v))
...
def _sort_json_schema(value: JsonSchemaValue,
                      parent_key: str | None = None) -> JsonSchemaValue:
    if isinstance(value, dict):
...
def _get_all_json_refs(item: Any) -> set[JsonRef]:
    ...
    if isinstance(item, dict):
        for key, value in item.items():
            if key == '$ref' and isinstance(value, str):
                # the isinstance check ensures that '$ref' isn't the name of a
                # property, etc.
...
def _get_typed_dict_cls(
        schema: core_schema.TypedDictSchema) -> type[Any] | None:
    metadata = _core_metadata.CoreMetadataHandler(schema).metadata
