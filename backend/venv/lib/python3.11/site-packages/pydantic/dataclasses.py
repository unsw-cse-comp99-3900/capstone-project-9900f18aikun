    ...
    if not force and cls.__pydantic_complete__:
        ...
        if _types_namespace is not None:
            ...
            if _parent_namespace_depth > 0:
                ...
                # here when implementing handling of recursive generics. See
                # BaseModel.model_rebuild for reference.
...
def is_pydantic_dataclass(
        __cls: type[Any]) -> TypeGuard[type[PydanticDataclass]]:
    ...
    """
    return dataclasses.is_dataclass(
        __cls) and '__pydantic_validator__' in __cls.__dict__
