...
SchemaKind: TypeAlias = Literal['BaseModel',
                                'TypeAdapter',
                                'dataclass',
                                'create_model',
                                'validate_call']
...
class PydanticPluginProtocol(Protocol):
    ...
    def new_schema_validator(self,
                             ...
                             plugin_settings: dict[str,
                                                   object],
                             ) -> tuple[ValidatePythonHandlerProtocol | None,
...
class ValidateStringsHandlerProtocol(BaseValidateHandlerProtocol, Protocol):
    ...
    def on_enter(self, input: StringInput, *, strict: bool |
                 None = None, context: dict[str, Any] | None = None) -> None:
        """Callback to be notified of validation start, and create an instance of the event handler.
