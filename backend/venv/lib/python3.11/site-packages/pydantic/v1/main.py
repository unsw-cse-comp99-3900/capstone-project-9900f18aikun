...
class ModelMetaclass(ABCMeta):
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # noqa C901
        ...
        for base in reversed(bases):
            if _is_base_model_class_defined and issubclass(
                    base, BaseModel) and base != BaseModel:
        ...
        def is_untouched(v: Any) -> bool:
            return isinstance(
                v, untouched_types) or v.__class__.__name__ == 'cython_function_or_method'

        if (namespace.get('__module__'), namespace.get(
                '__qualname__')) != ('pydantic.main', 'BaseModel'):
            annotations = resolve_annotations(
                namespace.get(
                    '__annotations__', {}), namespace.get(
                    '__module__', None))
            ...
            for ann_name, ann_type in annotations.items():
                if is_classvar(ann_type):
                    ...
                    if (is_untouched(value) and ann_type != PyObject and not any(lenient_issubclass(
                            get_origin(allowed_type), Type) for allowed_type in allowed_types)):
                        continue
        ...
        cls.__signature__ = ClassAttribute(
            '__signature__', generate_model_signature(
                cls.__init__, fields, config))
    ...
    def __instancecheck__(self, instance: Any) -> bool:
        ...
        return hasattr(
            instance,
            '__fields__') and super().__instancecheck__(instance)
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __getstate__(self) -> 'DictAny':
        ...
        return {
            ...
            '__private_attribute_values__': {
                k: v for k,
                v in private_attrs if v is not Undefined},
        }
    ...
    def __setstate__(self, state: 'DictAny') -> None:
        ...
        for name, value in state.get(
                '__private_attribute_values__', {}).items():
    ...
    def from_orm(cls: Type['Model'], obj: Any) -> 'Model':
        ...
        obj = {
            ROOT_KEY: obj} if cls.__custom_root_type__ else cls._decompose_class(obj)
        m = cls.__new__(cls)
    ...
    def copy(
        ...
        *,
        ...
        values = dict(self._iter(to_dict=False,
                                 by_alias=False,
                                 include=include,
                                 exclude=exclude,
                                 exclude_unset=False),
    ...
    def schema(
            cls,
            by_alias: bool = True,
            ref_template: str = default_ref_template) -> 'DictStrAny':
    ...
    def _get_value(
        ...
        if isinstance(v, dict):
            ...
            return v.__class__(
                *
                seq_args) if is_namedtuple(
                v.__class__) else v.__class__(seq_args)
    ...
    def __repr_args__(self) -> 'ReprArgs':
        return [(k, v) for k, v in self.__dict__.items() if k not in DUNDER_ATTRIBUTES and (
        ...
        if isinstance(f_def, tuple):
            try:
                ...
                raise ConfigError(
                    ...
                    'default values are not allowed') from e
        else:
...
def validate_model(  # noqa: C901 (ignore complexity)
    ...
    for validator in model.__pre_root_validators__:
        try:
            ...
            return {}, set(), ValidationError(
                [ErrorWrapper(exc, loc=ROOT_KEY)], cls_)
