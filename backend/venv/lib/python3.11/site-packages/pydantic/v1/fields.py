...
class FieldInfo(Representation):
    ...
    def __repr_args__(self) -> 'ReprArgs':
        ...
        return [(a, v) for a, v in attrs if v !=
                field_defaults_to_hide.get(a, None)]
    ...
    def get_constraints(self) -> Set[str]:
        ...
        return {
            attr for attr,
            default in self.__field_constraints__.items() if getattr(
                self,
                attr) != default}
...
class ModelField(Representation):
    ...
    def _type_analysis(self) -> None:  # noqa: C901 (ignore complexity)
        ...
        # even when declared with the other
            ...
            self.sub_fields = [
                self._create_sub_type(
                    t, f'{self.name}_{i}') for i, t in enumerate(
                    get_args(
                        self.type_))]
            self.type_ = origin
            return
    ...
    def _create_sub_type(
            ...
            name: str,
            *,
            for_keys: bool = False) -> 'ModelField':
        if for_keys:
    ...
    def populate_validators(self) -> None:
        ...
        self.validate_always = getattr(
            self.type_, 'validate_always', False) or any(
    ...
    def validate(self,
                 ...
                 *,
                 loc: 'LocStr',
                 cls: Optional['ModelOrDc'] = None) -> 'ValidateReturn':
    ...
    def _validate_tuple(
        ...
        for i, (v_, field) in enumerate(
                zip(v, self.sub_fields)):  # type: ignore
            v_loc = *loc, i
    ...
    def _get_mapping_value(
            self, original: T, converted: Dict[Any, Any]) -> Union[T, Dict[Any, Any]]:
        """
    ...
    def _apply_validators(self,
                          ...
                          validators: 'ValidatorsList') -> 'ValidateReturn':
    ...
    def is_complex(self) -> bool:
        ...
        return (
            self.shape != SHAPE_SINGLETON or hasattr(
                self.type_, '__pydantic_model__') or lenient_issubclass(
        ...
        if self.shape in MAPPING_LIKE_SHAPES:
            ...
            t = '{}[{}]'.format(
                display_as_type(
                    self.type_), ', '.join(
                    display_as_type(
                        f.type_) for f in self.sub_fields))
...
class ModelPrivateAttr(Representation):
    ...
    def __init__(
            ...
            default: Any = Undefined,
            *,
            default_factory: Optional[NoArgAnyCallable] = None) -> None:
        self.default = default
...
def is_finalvar_with_default_val(type_: Type[Any], val: Any) -> bool:
    return is_finalvar(
        type_) and val is not Undefined and not isinstance(val, FieldInfo)
