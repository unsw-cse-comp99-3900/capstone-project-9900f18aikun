...
@overload
def validate_arguments(func: None = None,
                       *,
                       config: 'ConfigType' = None) -> Callable[['AnyCallableT'],
                                                                'AnyCallableT']:
    ...
...
class ValidatedFunction:
    ...
    def build_values(self, args: Tuple[Any, ...],
    ...
    def create_model(self,
        ...
        class DecoratorBaseModel(BaseModel):
            ...
            @validator(self.v_kwargs_name,
                       check_fields=False, allow_reuse=True)
            def check_kwargs(
            ...
            @validator(V_POSITIONAL_ONLY_NAME,
                       check_fields=False, allow_reuse=True)
