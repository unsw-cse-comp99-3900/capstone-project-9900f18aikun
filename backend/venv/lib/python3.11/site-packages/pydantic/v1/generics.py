...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(
            cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        if all_identical(typevars_map.keys(),
        ...
        instance_type_hints = {
            k: v for k,
            v in type_hints if get_origin(v) is not ClassVar}
    ...
    def __concrete_name__(
            cls: Type[Any], params: Tuple[Type[Any], ...]) -> str:
    ...
    def __parameterized_bases__(
            cls, typevars_map: Parametrization) -> Iterator[Type[Any]]:
        """
            ...
            if not issubclass(base_model, GenericModel):
                ...
                if base_model in _assigned_parameters:
                    ...
                    mapped_types: Parametrization = {
                        key: typevars_map.get(
                            value,
                            value) for key,
                        value in _assigned_parameters[cls].items()}
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    if origin_type is Annotated:
        ...
        return Annotated[replace_types(
            annotated_type, type_map), tuple(annotations)]
    ...
    if not origin_type and lenient_issubclass(
            type_, GenericModel) and not type_.__concrete__:
...
def check_parameters_count(
        cls: Type[GenericModel], parameters: Tuple[Any, ...]) -> None:
...
def get_caller_frame_info() -> Tuple[Optional[str], bool]:
    ...
    return frame_globals.get(
        '__name__'), previous_caller_frame.f_locals is frame_globals
