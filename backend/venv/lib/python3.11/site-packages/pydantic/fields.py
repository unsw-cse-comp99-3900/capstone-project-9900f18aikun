...
class FieldInfo(_repr.Representation):
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        kwargs = {
            k: _DefaultValues.get(k) if v is _Unset else v for k,
            v in kwargs.items()}  # type: ignore
        ...
        alias_is_set = any(
            alias is not None for alias in (
                self.alias,
    ...
    @staticmethod
    def from_field(default: Any = PydanticUndefined,
                   **kwargs: Unpack[_FromFieldInfoInputs]) -> FieldInfo:
    ...
    def from_annotation(annotation: type[Any]) -> FieldInfo:
        ...
        if _typing_extra.is_annotated(annotation):
            ...
            field_info_annotations = [
                a for a in extra_args if isinstance(
                    a, FieldInfo)]
    ...
    def from_annotated_attribute(
        ...
        if isinstance(default, FieldInfo):
            ...
            default = default.merge_field_infos(
                *
                [
                    x for x in annotation_metadata if isinstance(
                        x,
                        FieldInfo)],
                default,
        ...
        *field_infos: FieldInfo,
        ...
        for field_info in field_infos:
            flattened_field_infos.extend(
                x for x in field_info.metadata if isinstance(
                    x, FieldInfo))
    ...
    def _from_dataclass_field(dc_field: DataclassField[Any]) -> FieldInfo:
        ...
        dc_field_metadata = {
            k: v for k,
            v in dc_field.metadata.items() if k in _FIELD_ARG_NAMES}
        return Field(
            default=default,
    ...
    def _extract_metadata(
            annotation: type[Any] | None) -> tuple[type[Any] | None, list[Any]]:
    ...
    def deprecation_message(self) -> str | None:
        ...
        return self.deprecated if isinstance(
            self.deprecated, str) else self.deprecated.message
    ...
    def rebuild_annotation(self) -> Any:
        ...
        if not self.metadata:
            ...
            return typing_extensions.Annotated[(
                self.annotation, *self.metadata)]  # type: ignore

    def apply_typevars_map(self,
                           typevars_map: dict[Any,
                                              Any] | None,
...
def _wrapped_property_is_private(
        property_: cached_property | property) -> bool:
