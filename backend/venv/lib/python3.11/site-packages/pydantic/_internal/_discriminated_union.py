...
def apply_discriminators(
    ...
    def inner(
            ...
            recurse: _core_utils.Recurse) -> core_schema.CoreSchema:
...
def apply_discriminator(
    ...
    return _ApplyInferredDiscriminator(
        discriminator, definitions or {}).apply(schema)
...
class _ApplyInferredDiscriminator:
    ...
    * Handling various edge cases such as 'definitions', 'default', 'nullable' schemas, and more
        ...
        * Updating the _tagged_union_choices mapping that will ultimately be used to build the TaggedUnionSchema.
        ...
        if choice['type'] == 'none':
            ...
            if choice['type'] == 'tagged-union' and self._is_discriminator_shared(
                ...
                # TaggedUnionSchema.
                subchoices = [
                    x for x in choice['choices'].values() if not isinstance(
                        x, (str, int))]
    ...
    def _is_discriminator_shared(
            self, choice: core_schema.TaggedUnionSchema) -> bool:
        ...
        return inner_discriminator == self.discriminator or (
            isinstance(
                inner_discriminator, list) and (
                self.discriminator in inner_discriminator or [
    ...
    def _infer_discriminator_values_for_field(
            self, field: CoreSchemaField, source: str) -> list[str | int]:
        ...
        if self._discriminator_alias is None:
            ...
            raise PydanticUserError(
                ...
                f'(got {alias}, {self._discriminator_alias})', code='discriminator-alias', )
    ...
    def _set_unique_choice_for_values(self,
