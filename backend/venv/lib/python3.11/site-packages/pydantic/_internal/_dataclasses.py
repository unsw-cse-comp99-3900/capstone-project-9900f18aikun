...
def complete_dataclass(
    ...
    *,
    ...
    # dataclass.__init__ must be defined here so its `__qualname__` can be
    # changed since functions can't be copied.
    def __init__(
    ...
    if config_wrapper.validate_assignment:
        ...
        def validated_setattr(instance: Any, field: str,
                              value: str, /) -> None:
...
def is_builtin_dataclass(
        _cls: type[Any]) -> TypeGuard[type[StandardDataclass]]:
    ...
    """
    return (
        dataclasses.is_dataclass(_cls) and not hasattr(
            _cls,
            '__pydantic_validator__') and set(
            _cls.__dataclass_fields__).issuperset(
                set(
                    getattr(
                        _cls,
                        '__annotations__',
