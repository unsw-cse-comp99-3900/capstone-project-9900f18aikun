...
CoreSchemaField = Union[core_schema.ModelField,
...
def get_type_ref(
        type_: type[Any], args_override: tuple[type[Any], ...] | None = None) -> str:
...
def collect_definitions(
        schema: core_schema.CoreSchema) -> dict[str, core_schema.CoreSchema]:
    defs: dict[str, CoreSchema] = {}

    def _record_valid_refs(
            s: core_schema.CoreSchema,
            recurse: Recurse) -> core_schema.CoreSchema:
        ref = get_ref(s)
        if ref:
            defs[ref] = s
...
class _WalkCoreSchema:
    ...
    def _build_schema_type_to_method(
            self) -> dict[core_schema.CoreSchemaType, Recurse]:
    ...
    def walk(self, schema: core_schema.CoreSchema,
             f: Walk) -> core_schema.CoreSchema:
        return f(schema, self._walk)

    def _walk(self, schema: core_schema.CoreSchema,
              f: Walk) -> core_schema.CoreSchema:
    ...
    def handle_definitions_schema(self,
    ...
    def handle_frozenset_schema(self,
    ...
    def handle_generator_schema(self,
    ...
    def handle_tagged_union_schema(self,
    ...
    def handle_lax_or_strict_schema(self,
    ...
    def handle_json_or_python_schema(self,
    ...
    def handle_model_fields_schema(self,
    ...
    def handle_typed_dict_schema(self,
    ...
    def handle_dataclass_args_schema(self,
    ...
    def handle_arguments_schema(self,
...
def simplify_schema_references(schema: core_schema.CoreSchema) -> core_schema.CoreSchema:  # noqa: C901
    ...
    def collect_refs(s: core_schema.CoreSchema,
                     recurse: Recurse) -> core_schema.CoreSchema:
    ...
    def count_refs(s: core_schema.CoreSchema,
                   recurse: Recurse) -> core_schema.CoreSchema:
    ...
    def can_be_inlined(
            s: core_schema.DefinitionReferenceSchema,
            ref: str) -> bool:
        if ref_counts[ref] > 1:
            return False
    ...
    def inline_refs(s: core_schema.CoreSchema,
                    recurse: Recurse) -> core_schema.CoreSchema:
        if s['type'] == 'definition-ref':
            ref = s['schema_ref']
