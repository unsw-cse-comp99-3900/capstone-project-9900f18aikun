...
class ValueItems(_repr.Representation):
    ...
    def for_element(
            self,
            e: int | str) -> AbstractSetIntStr | MappingIntStrAny | None:
    ...
    def _normalize_indexes(self, items: MappingIntStrAny,
                           v_length: int) -> dict[int | str, Any]:
        ...
        for i, v in items.items():
            if not (
                isinstance(
                    v,
                    typing.Mapping) or isinstance(
                    v,
                    typing.AbstractSet) or self.is_true(v)):
                raise TypeError(
    ...
    def _coerce_items(items: AbstractSetIntStr |
                      MappingIntStrAny) -> MappingIntStrAny:
...
def all_identical(
        left: typing.Iterable[Any],
        right: typing.Iterable[Any]) -> bool:
