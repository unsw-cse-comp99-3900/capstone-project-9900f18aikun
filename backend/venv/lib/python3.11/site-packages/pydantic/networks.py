...
* Host required
"""
WebsocketUrl = Annotated[Url, UrlConstraints(
...
* Host required
"""
RedisDsn = Annotated[Url,
                     UrlConstraints(allowed_schemes=['redis',
                                                     'rediss'],
...
* Host required
"""
NatsDsn = Annotated[MultiHostUrl, UrlConstraints(
...
* Host required
"""
MariaDBDsn = Annotated[Url,
                       UrlConstraints(allowed_schemes=['mariadb',
...
if TYPE_CHECKING:
    ...
    class EmailStr:
        ...
        def __get_pydantic_json_schema__(
                ...
                handler: _schema_generation_shared.GetJsonSchemaHandler) -> JsonSchemaValue:
...
class IPvAnyInterface:
    ...
    @classmethod
    def _validate(cls, input_value: NetworkType, /
