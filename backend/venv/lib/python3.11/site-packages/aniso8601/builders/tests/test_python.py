...
class TestPythonTimeBuilder_UtiltyFunctions(unittest.TestCase):
    ...
    def test_fractional_range_check(self):
        limit = Limit("Invalid string.", -1, 1, ValueError,
                      "Value must be between -1..1.", None)
        ...
        self.assertEqual(fractional_range_check(
            10, "-0.1", limit), FractionalComponent(-0, 1))
    ...
    def test_cast_to_fractional_component(self):
        ...
        self.assertEqual(_cast_to_fractional_component(
            10, "-1.1"), FractionalComponent(-1, 1))

        self.assertEqual(
            _cast_to_fractional_component(
                100, "1.1"), FractionalComponent(
                1, 10))
        self.assertEqual(_cast_to_fractional_component(
            100, "-1.1"), FractionalComponent(-1, 10))
...
class TestPythonTimeBuilder(unittest.TestCase):
    ...
    def test_build_duration(self):
        testtuples = (
            ...
            (
                ...
                datetime.timedelta(
                    days=1279, hours=12, minutes=30, seconds=5.5),
            ),
    ...
    def test_build_interval(self):
        testtuples = (
            ...
            (
                ...
                datetime.date(year=2014, month=11, day=12),
                datetime.datetime(
                    year=2014, month=11, day=12, hour=1, minute=0),
            ),
            (
                {
                    "start": DateTuple("2014", "11", "12", None, None, None),
            ...
            (
                ...
                datetime.datetime(
                    year=2007, month=12, day=14, hour=13, minute=30),
                datetime.datetime(
                    year=2007, month=12, day=14, hour=15, minute=30),
            ),
            (
                {
                    "start": DatetimeTuple(
            ...
            (
                ...
                datetime.datetime(
                    year=2007, month=11, day=13, hour=12, minute=34),
            ),
            # Make sure we truncate, not round
            # https://bitbucket.org/nielsenb/aniso8601/issues/10/sub-microsecond-precision-in-durations-is
            (
    ...
    def test_range_check_duration(self):
        ...
        with self.assertRaises(DayOutOfBoundsError):
            PythonTimeBuilder.build_duration(
                PnD=str(datetime.timedelta.max.days + 1))
    ...
    def test_range_check_interval(self):
        with self.assertRaises(YearOutOfBoundsError):
            PythonTimeBuilder.build_interval(
                start=DateTuple(
                    "0007", None, None, None, None, None), duration=DurationTuple(
                    None, None, None, str(
                        datetime.timedelta.max.days), None, None, None), )
        ...
        with self.assertRaises(YearOutOfBoundsError):
            PythonTimeBuilder.build_interval(
                    ...
                    "0001", None, None, None, None, None), duration=DurationTuple(
        ...
        with self.assertRaises(YearOutOfBoundsError):
            PythonTimeBuilder.build_interval(
                    ...
                    DateTuple(
                        "0001", None, None, None, None, None), TimeTuple(
                        "1", None, None, None), ), duration=DurationTuple(
    ...
    def test_date_generator(self):
        ...
        generator = PythonTimeBuilder._date_generator(
            startdate, timedelta, iterations)
    ...
    def test_date_generator_unbounded(self):
        ...
        generator = PythonTimeBuilder._date_generator_unbounded(
            startdate, timedelta)
