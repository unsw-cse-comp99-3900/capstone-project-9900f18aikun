...
class TestIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        ...
        self.assertEqual(
            get_interval_resolution("P1.5Y/2018-306"),
            IntervalResolution.Ordinal)
        self.assertEqual(
            get_interval_resolution("P1.5Y/2018W012"),
            IntervalResolution.Weekday)

        self.assertEqual(
            get_interval_resolution("2018/P1.5Y"),
            IntervalResolution.Year)
        self.assertEqual(
        ...
        self.assertEqual(
            get_interval_resolution("2018-306/P1.5Y"),
            IntervalResolution.Ordinal)
        self.assertEqual(
            get_interval_resolution("2018W012/P1.5Y"),
            IntervalResolution.Weekday)

    def test_get_interval_resolution_time(self):
        self.assertEqual(
            get_interval_resolution("P1M/1981-04-05T01"),
            IntervalResolution.Hours)
        self.assertEqual(
            get_interval_resolution("P1M/1981-04-05T01:01"),
            IntervalResolution.Minutes)
        self.assertEqual(
        ...
        self.assertEqual(
            get_interval_resolution("1981-04-05T01/P1M"),
            IntervalResolution.Hours)
        self.assertEqual(
            get_interval_resolution("1981-04-05T01:01/P1M"),
            IntervalResolution.Minutes)
        self.assertEqual(
    ...
    def test_get_interval_resolution_duration(self):
        self.assertEqual(
            get_interval_resolution("2014-11-12/P1Y2M3D"),
            IntervalResolution.Day)
        self.assertEqual(
        ...
        self.assertEqual(
            get_interval_resolution("2014-11-12/P1Y2M3DT4H"),
            IntervalResolution.Hours)
        self.assertEqual(
        ...
        self.assertEqual(
            get_interval_resolution("P1Y2M3D/2014-11-12"),
            IntervalResolution.Day)
        self.assertEqual(
        ...
        self.assertEqual(
            get_interval_resolution("P1Y2M3DT4H/2014-11-12"),
            IntervalResolution.Hours)
        self.assertEqual(
...
class TestRepeatingIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        self.assertEqual(get_repeating_interval_resolution(
            "R/P1.5Y/2018"), IntervalResolution.Year)
        self.assertEqual(
        ...
        self.assertEqual(get_repeating_interval_resolution(
            "R/2018/P1.5Y"), IntervalResolution.Year)
        self.assertEqual(
    ...
    def test_parse_repeating_interval_mockbuilder(self):
        ...
        result = parse_repeating_interval(
            "R3/1981-04-05/P1D", builder=mockBuilder)
